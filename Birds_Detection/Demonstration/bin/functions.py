...
c3poFolder="/mnt/BigFast/VegaFastExtension/Rpackages/c3po_all/c3po_interface_mark/"
...
def place_generate_sqaure(imageB,cnts):
    ...
    cv2.imwrite("/mnt/BigFast/VegaFastExtension/Rpackages/c3po_all/c3po_interface/bin/Output_images/annote.jpg",imageRectangles)
...
def extract_birds(name_test,name_ref,folder,diff_mod="HSV",coverage_threshold=0.99):
    ...
    cnts=diff_images(imageA,imageB)
    """
    if mask==True:
...
def extract_size(name_test,name_ref,folder,CNNmodel,diff_mod="GBR",
    ...
    cnts=diff_images(imageA,imageB,blockSize=blockSize,contrast=contrast,blurFact=blurFact)
    batchImages_stack_reshape,table_non_filtre=batched_cnts(cnts,imageB) 
