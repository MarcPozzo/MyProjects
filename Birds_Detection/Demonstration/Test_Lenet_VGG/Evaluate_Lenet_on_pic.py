...
parameters_=[("bird_large","light",25,50),("bird_large","light",25,-1),("bird_large","light",17,-1)] #Parameters of diff used in the loop
objects_to_keep_=['corneille', 'faisan', 'lapin','chevreuil', 'pigeon']
...
Images=Images[Images["classe"].isin( objects_to_keep_ )]
