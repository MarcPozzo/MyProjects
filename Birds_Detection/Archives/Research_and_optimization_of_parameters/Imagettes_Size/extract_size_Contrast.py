...
contrast_liste=[-7,-5,-3]
blockSize_liste
for contrast in contrast_liste:
    #path_save="/mnt/VegaSlowDataDisk/c3po_interface_mark/Materiels/listes/Comp_imgen_imanote/"+"BS"+str(contrast)+"/"
    ...
    for folder in liste_folders:
        ...
        for name_test in liste_name_test:
            ...
            surface_carre_gen_liste, surface_anote_liste,imagette_coverage_liste=fns.extract_size_imagettes(name_test,name_ref,folder,contrast=-5,blockSize=17,blurFact=17)
    ...
    path_save="/mnt/VegaSlowDataDisk/c3po_interface_mark/Materiels/listes/Comp_imgen_imanote/C"+str(contrast)+"/"
    
    with open(path_save+"surface_carre_gen_tous_fichiers_C"+str(contrast)+".txt", "wb") as fp:   #Pickling
        pickle.dump(surface_carre_gen_tous_fichiers, fp)
    
     
    with open(path_save+"surface_anote_liste_tous_fichiers_C"+str(contrast)+".txt", "wb") as fp:   #Pickling
