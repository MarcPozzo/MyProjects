...
for folder in liste_folders:
    ...
    for name_test in liste_name_test:
        ...
        imageA,imageB,cnts,batchImages_stack_reshape,generate_square,TP_birds,FP,TP_estimates,FP_estimates=base_4C(name_test,name_ref,folder,CNNmodel,diff_mod,mask=True)
