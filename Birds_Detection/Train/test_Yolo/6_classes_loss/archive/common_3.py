...
def read_imagettes(imagettes,nbr):
  images=[]
  labels=[]
  labels2=[]
  ...
  for i in range(nbr):
      for name_test in liste_name_test:
          image, label, label2=prepare_labels_marc_first(name_test, imagettes_copy)
...
def prepare_labels_marc_first(name_test,imagettes):
